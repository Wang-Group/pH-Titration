...
| Current matched timing and one-observation recovery (block 16) | The same 20 task IDs from each of five locked benchmark seeds | 100 per method | Task-level medians and paired PF/PyMC tests |
