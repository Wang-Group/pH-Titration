...
class FixedKParticleFilter:
    ...
    def update(
        ...
        if ess < ESS_THRESHOLD_FRACTION * self.particle_count:
            ...
            # Keep rejuvenated proposals inside a broad numerical/chemical
            # stability envelope; this regularizes charge-balance solves and is
            # not a species-specific thermodynamic prior.
